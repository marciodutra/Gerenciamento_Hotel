...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center mb-5">Registro do Sistema de Gestão Hoteleira</h2>
            <div class="row">
                <div class="col-md-6 mx-auto card-holder">
                    <div class="card border-secondary">
                        <div class="card-header">
                            <h3 class="mb-0 my-2">Inscrever-se</h3>
                        </div>
                        <div class="card-body">
                            <form class="form" role="form" autocomplete="off" id="registration-form" method="post">
                                <div class="form-group">
                                    <label for="registrationFullName">Nome</label>
                                ...
                                <div class="form-group">
                                    <label for="registrationPhoneNumber">Número de telefone</label>
                                    <input type="text" class="form-control"
                                ...
                                <div class="form-group">
                                    <label for="registrationPassword">Senha</label>
                                    <span class="red-asterisk"> *</span>
                                ...
                                <div class="form-group">
                                    <label for="registrationPassword2">Confirme sua senha</label>
                                    <span class="red-asterisk"> *</span>
                                    <input type="password" class="form-control"
                                ...
                                <div class="form-group">
                                    <p>Já é registrado? <a href="sign-in.php">Faça login aqui.</a></p>
                                </div>
                                <div class="form-group">
